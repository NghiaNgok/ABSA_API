...
aspect_categories = {
    "Chất lượng sản phẩm": [
        ...
        "thân máy", "đt", "may", "điên thoai", "dien thoai", "đồ nokia", "đt nokia", "iphone", "iphone 13",
    ],
    "Giá cả và chi phí": [
...
def predict_overall_sentiment(sentence):
    ...
    overall_sentiment = "Positive" if predicted_class == 2 else "Neutral" if predicted_class == 1 else "Negative"
...
def infer(sentence):
    ...
    # Dự đoán overall sentiment của toàn bộ câu
    overall_sentiment = predict_overall_sentiment(sentence)
